...
"""
    ...
    The patern to follow:
        ...
        https://stackoverflow.com/questions/59340651/adding-turtlescreen-to-canvas-toplevel-object-has-no-attribute-call

        Edit the file /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/turtle.py
        and comment out the lines re 'darwin'
"""
