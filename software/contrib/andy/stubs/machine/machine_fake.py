...
class Pin:
    ...
    def __init__(self, id: Union[int, str], /, mode: int = IN, pull: int = PULL_UP, af: Union[str, int] = -1):
        ...
        """
        # ANDY implement an actual value
        self._value = 0
        # ANDY remember the id
        self._id = id
    ...
    def irq(self, handler=None, direction: int = 0):
        """
    ...
    # ANDY implement override for value methods - https://www.geeksforgeeks.org/python-method-overloading/
...
class PWM:
    ...
    def duty_u16(self, duration: int):
        ...
        """
        # ANDY: Perhaps set a timer for the duration somehow?
        self._pin.value(duration)
    ...
    def freq(self, frequency: int):
        ...
        """
        # print('PWM pin, should set freq to', frequency)
...
# ANDY EXTRAS TO SUPPORT EUROPI

# Map the GPIO pins to the EuroPi board
gpio_pin_to_europi_cvout = {
    21: 1,
    20: 2,
    16: 3,
    17: 4,
